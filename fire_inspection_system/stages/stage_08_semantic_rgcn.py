...
def _build_s08_runtime():
    ...
    DEFAULT_DATASET_MANIFEST = BUNDLED_MODEL_DIR / 'dataset_manifest.json'
    DEFAULT_RGCN_CHECKPOINT = BUNDLED_MODEL_DIR / 'edge_gated_rgcn_pretrained.pt'
    DEFAULT_ROUTE_HEAD_CHECKPOINT = BUNDLED_MODEL_DIR / 'pseudo_label_selection_transition_heads.pt'
