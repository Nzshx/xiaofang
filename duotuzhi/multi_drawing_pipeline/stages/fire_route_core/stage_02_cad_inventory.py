...
# -----------------------------------------------------------------------------
# Migrated implementation: multi_drawing_pipeline.stages.fire_route_core/cad_vector_extraction.py
# -----------------------------------------------------------------------------
def _build_s02_api():
    __file__ = str(
        __import__("pathlib").Path(globals()["__file__"]).resolve().parents[2]
        / 'multi_drawing_pipeline.stages.fire_route_core/cad_vector_extraction.py'
    )
    __name__ = 'multi_drawing_pipeline.stages.fire_route_core.cad_vector_extraction'
...
_s02_api = _register_embedded_module(
    'multi_drawing_pipeline.stages.fire_route_core.cad_vector_extraction',
    _build_s02_api(),
